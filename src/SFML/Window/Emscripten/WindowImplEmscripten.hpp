...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    WindowImplEmscripten(VideoMode mode, const String& title, unsigned long style);
...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool processEvent(sf::Event& windowEvent);
    ...
    std::deque<sf::Event> m_events;      ///< Queue we use to store pending events for this window
